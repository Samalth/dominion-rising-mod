package com.example.dominionrising.forge.gui;
...
/**
 * Forge implementation of Army Station menu
 */
public class ArmyStationMenu extends AbstractContainerMenu {
    ...
    public ArmyStationMenu(int containerId, Inventory playerInventory, BlockPos blockPos, Level level) {
        super(com.example.dominionrising.forge.registry.ModMenuTypes.ARMY_STATION_MENU.get(), containerId);
